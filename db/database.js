...
export default class DB {
	...
	// 		PouchDB.sync(this.name, 'https://therick:compaq@couchdb-2afa5d.smileupps.com/' + this.name, )
	// 	.then((res) => {
	// 		console.log('====================================');
	// 		console.log(res);
	// 		console.log('====================================');
	...
	async addingMoreData(data){
		...
		if(this.name === 'landlords'){
			...
			console.log(historyData.rentCollection,'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
			return data.map(landlordDetails=>{
				...
				return {...landlordDetails,unpaid:totalRentCollected,uncollected:uncollected}
			})
