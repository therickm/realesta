                ...
                <div className="content" style={{ display: 'flex' }}>
                    <div className='main'>
                        <Descriptions size="small" column={1}>
                            ...
                            <Descriptions.Item label="Average Management Percentage">{aManagementPercentage}</Descriptions.Item>
                        </Descriptions>
                    </div>
                    <Space className='extra'>
                        ...
                        >   
                            ...
                            precision={2}
                                ...
                                title={<>% Rent <Badge count={`${((totalUnits - occupiedUnits)/totalUnits)*100} %`} style={{ backgroundColor: '#fa8c16' }} /></>}
                                suffix="%" 
								value={((totalRent-occupiedRent)/totalRent)*100}  
